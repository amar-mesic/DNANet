...
from train.experiment_setup import create_output_dir, set_random_seeds, setup_logging, setup_neptune
...
def run(real_data_config: str,
    ...
    run = setup_neptune(log_neptune, experiment_name)

    # Set up output directory
    output_dir = create_output_dir(experiment_name)
    ...
    # Do this after fold is determined
